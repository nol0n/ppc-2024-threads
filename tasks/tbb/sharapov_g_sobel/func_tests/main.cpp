// Copyright 2024 Sharapov GeorgiySSobelTbb
...
TEST(sharapov_g_sobel_tbb, Test_Seed_1234) {
  int width = 10;
  int height = 10;
  std::vector<SSobelTbb::RGB> ColoredImage = {
  ...
  std::vector<SSobelTbb::GrayScale> EdgeImageExpected = {
  ...
  // Task
  SSobelTbb SSobelTbb(taskDataTbb);
  ASSERT_EQ(SSobelTbb.validation(), true);
  ASSERT_EQ(SSobelTbb.pre_processing(), true);
  ASSERT_EQ(SSobelTbb.run(), true);
  ASSERT_EQ(SSobelTbb.post_processing(), true);
...
TEST(sharapov_g_sobel_tbb, Test_Seed_2451) {
  int width = 10;
  int height = 10;
  std::vector<SSobelTbb::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_tbb, Test_Seed_2423) {
  int width = 10;
  int height = 10;
  std::vector<SSobelTbb::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_tbb, Test_Seed_2354) {
  int width = 10;
  int height = 10;
  std::vector<SSobelTbb::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_tbb, Test_Seed_3453) {
  int width = 10;
  int height = 10;
  std::vector<SSobelTbb::RGB> ColoredImage = {
